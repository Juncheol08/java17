...
public class CollectionsEx1 {
    public static void main(String[] args) {
        ...
        System.out.println("이번 달의 몇번째 주 : "+c1.get(Calendar.WEEK_OF_MONTH));
        System.out.println();
        ...
        c1.clear();     //1970년 1월1일로 날짜 초기화
        System.out.println(sdf.format(c1.getTime()));
        c1.set(1996,8-1,25,14,30); //month는 0부터 1월
        System.out.println(sdf.format(c1.getTime()));
